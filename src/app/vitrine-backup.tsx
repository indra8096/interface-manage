...
export default function Home() {
  ...
  return (
    <div className="min-h-screen transition-all duration-300 bg-black text-white font-karla">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              <button onClick={() => scrollToSection('features')} className="text-sm font-medium transition-colors text-gray-300 hover:text-white">Fonctionnalités</button>
              <button onClick={() => scrollToSection('interfaces')} className="text-sm font-medium transition-colors text-gray-300 hover:text-white">Interfaces</button>
              <button onClick={() => scrollToSection('tech')} className="text-sm font-medium transition-colors text-gray-300 hover:text-white">Technologies</button>
              <button onClick={() => scrollToSection('purple-team')} className="text-sm font-medium transition-colors text-gray-300 hover:text-white">Purple Team</button>
            </div>

            <div className="animate-fade-in">
              <a href="/login" className="px-6 py-2 text-black font-bold rounded-lg hover:scale-105 transition-all duration-300" style={{ background: 'white' }}>
                CONNEXION
              </a>
            </div>
          </div>
      ...
      <section id="hero" className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8 animate-slide-up">
            <h1 className="text-5xl md:text-7xl font-bold mb-6" style={{ color: '#CCFF00' }}>
              Drelto
                 </h1>
          ...
          <div className="flex justify-center items-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <button onClick={() => scrollToSection('features')} className="px-8 py-4 border-2 font-bold rounded-xl transition-all duration-300 text-lg" style={{ borderColor: '#CCFF00', color: '#CCFF00' }}>
              DÉCOUVRIR
            </button>
            </div>
          ...
          <div className="mt-16 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <div className="relative">
              ...
              <div className="relative bg-black/50 backdrop-blur-md rounded-2xl p-8 border border-gray-800">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2" style={{ color: '#CCFF00' }}>Performance</h3>
                    <p className="text-gray-400">Interface rapide, détaillée, simple et optimisée.</p>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2" style={{ color: '#CCFF00' }}>Sécurité</h3>
                    <p className="text-gray-400">Contrôle d&apos;accès basé sur les rôles</p>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-2" style={{ color: '#CCFF00' }}>Design</h3>
      ...
      <section id="features" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#9933FF' }}>
              Fonctionnalités
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-black/50 backdrop-blur-md rounded-xl p-6 border border-gray-700 hover:border-[#CCFF00] transition-all duration-300 hover:scale-105 animate-slide-up">
              <h3 className="text-xl font-bold mb-3" style={{ color: '#CCFF00' }}>Dashboard Interactif</h3>
            ...
            <div className="bg-black/50 backdrop-blur-md rounded-xl p-6 border border-gray-700 hover:border-[#CCFF00] transition-all duration-300 hover:scale-105 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              <h3 className="text-xl font-bold mb-3" style={{ color: '#CCFF00' }}>Gestion des Utilisateurs</h3>
            ...
            <div className="bg-black/50 backdrop-blur-md rounded-xl p-6 border border-gray-700 hover:border-[#CCFF00] transition-all duration-300 hover:scale-105 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <h3 className="text-xl font-bold mb-3" style={{ color: '#CCFF00' }}>Services Prédéfinis</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center group animate-slide-up">
              <h3 className="font-bold text-lg" style={{ color: '#CCFF00' }}>Next.js 15</h3>
            </div>

            <div className="text-center group animate-slide-up" style={{ animationDelay: '0.1s' }}>
              <h3 className="font-bold text-lg" style={{ color: '#CCFF00' }}>TypeScript</h3>
            </div>

            <div className="text-center group animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <h3 className="font-bold text-lg" style={{ color: '#CCFF00' }}>Tailwind CSS</h3>
              </div>

            <div className="text-center group animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <h3 className="font-bold text-lg" style={{ color: '#CCFF00' }}>Framer Motion</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="purple-team" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-black/50 backdrop-blur-md rounded-2xl p-8 border border-gray-700 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="text-center mb-8">
              <p className="text-lg text-gray-300 font-medium max-w-4xl mx-auto">
            ...
            <div className="mt-12 p-8 bg-gray-900/50 rounded-xl border border-gray-700 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="text-center">
                <h3 className="text-xl font-bold mb-4" style={{ color: '#CCFF00' }}>Comment Drelto facilite l&apos;approche Purple Team</h3>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            <div className="flex items-center justify-center space-x-2 mb-6">
              <span className="text-2xl font-bold" style={{ color: '#CCFF00' }}>
                Drelto
              </span>
                      </div>
            ...
            <div className="flex justify-center space-x-6">
              <a href="#features" className="text-gray-400 hover:text-[#CCFF00] transition-colors">
                Fonctionnalités
              </a>
