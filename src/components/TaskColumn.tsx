...
export default function TaskColumn({ category, tasks, onAddTask, onStatusChange, onDropService, userRole = 'user', onAddTaskFromPanel, tasksAddedFromPanel = [], onRemoveTaskFromPanel, currentUserName }: TaskColumnProps) {
